...
function AppCard({
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-800/80 bg-slate-950/50 p-5">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <AppCard
          eyebrow="TV device"
          title="VONO Streamer for Android TV / Google TV"
          ...
          footer={
            <div>
              ...
              <ol className="mt-3 space-y-3">
                <Step n={1}>On the TV device, open the web browser and go to this page, then tap <strong className="text-slate-200">Download VONO Streamer</strong>.</Step>
